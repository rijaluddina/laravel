    ...
    <form action="{{ route('front.payment_confirm') }}" method="POST" enctype="multipart/form-data"
        ...
        <section id="payment-details"
            ...
            <div class="flex items-center justify-between">
                ...
                <p class="font-bold">Rp {{ number_format($orderData['subtotal_amount'], 0, ',', '.') }}</p>
            </div>
            <div class="flex items-center justify-between">
        ...
        <section id="send-payment-to"
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="flex flex-col gap-[2px]">
                    <p class="font-semibold flex items-center">JuaraTiket Indonesia <img
