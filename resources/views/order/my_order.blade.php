    ...
    <body>
        <div class="relative flex flex-col w-full max-w-[640px] min-h-screen gap-5 mx-auto bg-[#F5F5F0]">
            <div class="flex flex-col items-center justify-center px-4 gap-[30px] my-auto">
                <form action="booking-details.html" class="flex flex-col w-full max-w-[330px] rounded-[30px] p-5 gap-6 bg-white">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex items-center w-full rounded-full px-[14px] gap-[10px] overflow-hidden bg-[#F8F8F9] transition-all duration-300 focus-within:ring-2 focus-within:ring-[#FFC700]">
                            ...
                            <input type="text" name="booking-id" id="booking-id" class="appearance-none outline-none bg-[#F8F8F9] w-full font-semibold leading-[21px] placeholder:font-normal py-[14px]" placeholder="What’s your booking ID">
                        </div>
                    </div>
                    <div class="flex flex-col gap-2">
